...
import HandleComponet from "@/components/HandleComponent";
...
const DesignConfigurator = ({
    ...
    const {mutate: saveConfig, isPending } = useMutation({
        ...
        onError: () => {
            toast({
                ...
                description: "There was an error on our end. Plese try again.",
                variant: "destructive"
            })
        },
        onSuccess: () => {
    ...
    const [renderedPosition, setRenderedPostion] = useState({
        x: 150,
        y:250,
    })
    ...
    async function saveConfiguration(){
        try{
          ...
          await startUpload([file],{configId})
            ...
            toast({
                title: 'Something went wrong',
                description: 'there was a problem saving your config, plese try again.',
                variant: 'destructive',
            })
        }
    }
    ...
    return <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
        ...
        border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none
        focus:ring-2 focus:ring-primary focus:ring-offset-2">
            ...
            resizeHandleComponent={{
                bottomRight: <HandleComponet/>,
                bottomLeft: <HandleComponet/>,
                topRight: <HandleComponet/>,
                topLeft: <HandleComponet/>,
            }}
            >
