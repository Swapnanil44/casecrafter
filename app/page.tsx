        ...
        sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            flex flex-col items-center lg:items-start">
              ...
              text-slate-900 text-5xl md:text-6xl lg:text-7xl">
                Your Image on a <span className="bg-green-600 px-2 text-white">Custom</span> Phone Case
              </h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-porse text-center
              lg:text-left text-balance md:text-wrap">
                Capture your favourite memories with your own,{''}
                <span className="font-semibold">one-of-one</span> phone case.
                CaseCrafter allows you to protect your memories, not just your phone case.
              </p>
              
              <ul className="mt-8 space-y-2 text-left 
              font-medium flex flex-col items-center sm:items-start">
          ...
          justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
              <div className="relative md:max-w-xl">
                ...
                />
                <PhoneComponent className="w-64" imgSrc="/testimonials/1.jpg"/>
              </div>
          </div>
        </MaxWidthWrapper>
      </section>
        ...
        <div className='flex flex-col lg:flex-row items-center gap-4 sm:gap-6'>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                ...
                "The case feels durable and I even got a compliment on the design.
                  ...
                  {" "}on the case I had before, the image fading into yellow-ish color after a couple weeks. Love it."
                </p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "I usually keep my phone togather with my keys 
                   in my pocket and that led to some pretty heavy 
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              <PhoneComponent className="w-60" imgSrc="/horse_phone.jpg"/>
            </div>
          </div>
